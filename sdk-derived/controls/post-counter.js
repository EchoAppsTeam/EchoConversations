...
/**
 * @class Echo.StreamServer.Controls.PostCounter
 ...
 *
 * 	new Echo.StreamServer.Controls.PostCounter({
 ...
 *
 * @constructor
 * Counter constructor initializing Echo.StreamServer.Controls.PostCounter class
 *
 * @param {Object} config
 * Configuration options
 */
var counter = Echo.Control.manifest("Echo.StreamServer.Controls.PostCounter");
...
/**
 * @echo_event Echo.StreamServer.Controls.PostCounter.onReady
 * Triggered when the app initialization is finished completely.
 */
/**
 * @echo_event Echo.StreamServer.Controls.PostCounter.onRefresh
 ...
 */
/**
 * @echo_event Echo.StreamServer.Controls.PostCounter.onRender
 * Triggered when the app is rendered.
 */
/**
 * @echo_event Echo.StreamServer.Controls.PostCounter.onRerender
...
counter.templates.main =
	'<span class="{class:count}"></span>';

counter.renderers.count = function(element) {
	return element
		.empty()
		.append(this.get("data.count"));
};
...
counter.methods._maybeUpdate = function(data) {
	if ($.isEmptyObject(this.data) || this.data.count !== data.count) {
		/**
		 * @echo_event Echo.StreamServer.Controls.PostCounter.onUpdate
...
counter.methods._error = function(data, options) {
	/**
	 * @echo_event Echo.StreamServer.Controls.PostCounter.onError
