...
card.templates.photo =
			'<div class="{class:item}">' +
				'<div class="{class:photo}">' +
					'<div class="{class:photoAvatar}"><img src="{config:defaultAvatar}"/>{data:author_name}</div>' +
...
card.templates.video =
			'<div class="{class:item}">' +
				'<div class="{class:video}">' +
					'<div class="{class:videoAvatar}"><img src="{config:defaultAvatar}"/>{data:author_name}</div>' +
