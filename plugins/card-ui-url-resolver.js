...
plugin.css =
	...
	'.{plugin.class:Close} { width: 33px; height: 33px; background: rgba(0, 0, 0, 0.7); line-height: 33px; text-align: center; font-size: 30px; border-radius: 50%; font-weight: bold; position: absolute; top: 8px; right: 8px; cursor: pointer; color: #FFF; }' +
